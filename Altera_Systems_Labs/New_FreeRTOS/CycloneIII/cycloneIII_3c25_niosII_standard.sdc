...
create_clock -period "125 MHz" -name top_tx_clk_to_the_tse_mac [ get_keepers top_HC_TX_CLK]
create_clock -period "125 MHz" -name top_rx_clk_to_the_tse_mac [ get_keepers top_HC_RX_CLK]
