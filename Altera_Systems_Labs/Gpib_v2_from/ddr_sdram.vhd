...
-- ============================================================
-- Generated by DDR High Performance Controller 10.1 [Altera, IP Toolbench 1.3.0 Build 153]
-- ************************************************************
...
ARCHITECTURE SYN OF ddr_sdram IS
	...
	COMPONENT ddr_sdram_controller_phy
	PORT (
		local_address	: IN STD_LOGIC_VECTOR (22 DOWNTO 0);
		local_write_req	: IN STD_LOGIC;
		local_read_req	: IN STD_LOGIC;
...
BEGIN
	...
	ddr_sdram_controller_phy_inst : ddr_sdram_controller_phy
	PORT MAP (
...
-- Retrieval info: <MEGACORE title="DDR SDRAM Controller with ALTMEMPHY"  version="10.1"  build="153"  iptb_version="1.3.0 Build 153"  format_version="120" >
...
-- Retrieval info:      <PRIVATE name = "alt_top" value="ddr_sdram_alt_ddrx_controller_wrapper"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "nativelink_excludes" value="ddr_sdram_phy_alt_mem_phy_seq_wrapper.vhd,ddr_sdram_phy_alt_mem_phy_seq_wrapper.v,ddr_sdram_phy.vhd,ddr_sdram_phy_alt_mem_phy.v,alt_mem_phy_defines.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "nativelink_includes" value="ddr_sdram_phy.vho,ddr_sdram_phy_alt_mem_phy_seq_wrapper.vho"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "filename" value="ddr_sdram_alt_ddrx_controller_wrapper.vho"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
-- Retrieval info:     <NAMESPACE name = "simgen2">
-- Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+ddr_sdram_alt_mem_phy_seq_wrapper;+ddr_sdram_alt_mem_phy_reconfig;+ddr_sdram_alt_mem_phy_pll;+ddr_sdram_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=/home/ngunton/Avionics_B_lab/Gpib_v2_from/v2_adc_restored/ddr_sdram_simgen_init.txt"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
